...
const HeroBanner = () => {
  return (
    <Box sx={{ mt: { lg: "212px", xs: "70px" }, ml: { sm: "50px" } }}>
      ...
      <Typography fontWeight={600} color="#FF2625" sx={{ opacity: 0.1, display: { lg: 'block', xs: 'none', }, fontSize: '110px' }} >Exercises</Typography>
      <img src={HeroImg} alt="hero-img" className="hero-banner-img"  />
    </Box>
  );
};
